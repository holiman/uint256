...
// ReverseBytes sets z to the value of x with x's 32-byte representation reversed.
...
// z.SetBytes32(b32[:])
//
// ReverseBytes is helpful when converting between big- and little-endian serialization.
